...
<body>
	<div id="wrapper">
		<div class="logo">
			...
			<div class="banner">
				<@s.messageArgs code="login.welcome" args=["${(user.nickname)!''}"]></@s.messageArgs>
			</div>
			<div id="language">
		...
		<#-- start mainNav -->
		<ul id="mainNav">
			<li><a href="<@s.url relativeUrl="/admin/index" />" <#if parentNav==index0 >class="active"</#if> >${index0}</a></li>
			<li><a href="<@s.url relativeUrl="/admin/content/createArticle" />" <#if parentNav==index1 >class="active"</#if> >${index1}</a></li>
			<li><a href="<@s.url relativeUrl="/admin/user/updateBase"/>" <#if parentNav==index2 >class="active"</#if> >${index2}</a></li>
			<li><a href="<@s.url relativeUrl="/admin/contact/readContact"/>" <#if parentNav==index4 >class="active"</#if> >${index4}</a></li>
			<li><a href="<@s.url relativeUrl="/admin/site/readTrack"/>" <#if parentNav==index3 >class="active"</#if> >${index3}</a></li>
			<li class="logout"><a href='<@s.url relativeUrl="/logout"/>'><@s.message code="site.logout"/></a></li>
		</ul>
		<#-- // #end mainNav -->
